...
class Animation extends NewCommandParent {
  final Logger logr;
  @override
  String get outPath => 'src/presentation/animations/';

  Animation(this.logr) : super(logger: logr) {
    argParser
  ...
  @override
  String get description => 'create animation widget';
